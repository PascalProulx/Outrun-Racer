...
public class CarAnimation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((_rightjoystick.Horizontal == -1f || Input.GetKeyDown(KeyCode.Q)) && CarController._canTurn == true)
        {
        ...
        if ((_rightjoystick.Horizontal == 1f || Input.GetKeyDown(KeyCode.E)) && CarController._canTurn == true)
        {
